...
from solbot.monitor_scraper import MonitorScraper
...
class Solbot:
    ...
    def __init__(self, config: BotConfig):
        ...
        self._monitor_scraper = MonitorScraper(self)
    ...
    async def start(self):
        ...
        # Start the address monitor scraper
        asyncio.create_task(self._monitor_scraper.background_task())
